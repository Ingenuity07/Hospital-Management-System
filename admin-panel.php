...
<html lang="en">
  ...
  <style type="text/css">
    ...
    body{
      /* background: url("shivam_img/bg3_hms.jpg");
...
.list-group-item {
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif; color:white;"> Welcome &nbsp<?php echo $username ?> 
   </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class=" list-group" id="list-tab" role="tablist">
      <a class="text-light list-group-item list-group-item-action active" id="list-dash-list" data-toggle="list" href="#list-dash" role="tab" aria-controls="home">Dashboard</a>
      <a class="text-light list-group-item list-group-item-action" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Book Appointment</a>
      <a class="text-light list-group-item list-group-item-action" href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home">Appointment History</a>
      <a class="text-light list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">Prescriptions</a>
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class=" text-light StepTitle" style="margin-top: 5%;"> Book My Appointment</h4>
                      <script>
                      ...
                      <p class="links cl-effect-1 ">
                        <a class="text-success" href="#list-home" onclick="clickDiv('#list-home-list')">
                          Book Appointment
                        </a>
                      </p>
                    </div>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="text-light StepTitle" style="margin-top: 5%;">My Appointments</h2>
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-success" ></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="text-light StepTitle" style="margin-top: 5%;">Prescriptions</h2>
                    
                      <p class="cl-effect-1">
                        <a class="text-success" href="#list-pres" onclick="clickDiv('#list-pres-list')">
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="">
            <div class="card-body">
              <center><h4 class ="text-light">Create an appointment</h4></center><br>
              <form class="form-group" method="post" action="admin-panel.php">
                <div class="row">
                  ...
                  ?> -->
                    ...
                    <div class="col-md-4">
                          <label class ="text-light" for="spec">Specialization:</label>
                        </div>
                        <div class="col-md-8">
              ...
              <div class="col-md-4"><label class ="text-light" for="doctor">Doctors:</label></div>
                <div class="col-md-8">
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-4"><label class ="text-light" for="consultancyfees">
                                Consultancy Fees
                              </label></div>
                              <div class="col-md-8">
                  ...
                  <div class="col-md-4"><label class ="text-light">Appointment Date</label></div>
                  <div class="col-md-8"><input type="date" class="form-control datepicker" name="appdate"></div><br><br>

                  <div class="col-md-4"><label class ="text-light">Appointment Time</label></div>
                  <div class="col-md-8">
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="app-submit" value="Create new entry" class="btn btn-success" id="inputbtn">
                  </div>
