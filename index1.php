      ...
      <div class="row">
         ...
         <div class="col-md-4" style="margin:auto;">
          <div class="" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                <i class="fa fa-hospital-o fa-3x" aria-hidden="true" style="color:#000000"></i>
                <br>
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 160px;margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="patsub" value="Login" style="background-color: #000000; color:white;" class="btn "></center></div>           
