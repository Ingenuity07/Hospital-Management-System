...
body{
      background: url("shivam_img/bg1_hms.jpg");
...
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp GROUP-5 HOSPITAL</h4></a> 
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    ...
                    <div class="col-md register" style="margin-top: 0px;">
                        <ul class="nav nav-tabs nav-justified " id="myTab" role="tablist" style="width: 40%; background-color:#343a40;">
                            <li class="nav-item">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a style="color:black" href="index1.php">Already have an account?</a>
                                        </div>
</div>
                                    <div class="col-md-6">
                                        <div class="form-group">
